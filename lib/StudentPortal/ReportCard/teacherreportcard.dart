...
class TeacherReportCard extends StatefulWidget {
  const TeacherReportCard({super.key});
  @override
  State<TeacherReportCard> createState() => _TeacherReportCardState();
}

class _TeacherReportCardState extends State<TeacherReportCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      // to show performance profile of student
      body: Stack(
...
// to show data of generalProfiles
