...
import 'package:school_management_system/TeacherPortal/TeacherProfile/editprofileteacher.dart';
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const EditProfileTeacher(),
                    ));
              },
              child: Container(
